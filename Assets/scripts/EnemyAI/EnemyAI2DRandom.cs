...
// AQUÍ ESTABA EL ERROR: Cambiamos EnemyAI2D por EnemyRandom
public class EnemyRandom : MonoBehaviour 
{
    ...
    void FixedUpdate()
    {
        ...
        // Oscilación
        float wobble = Mathf.Sin(Time.time * wobbleSpeed + randomOffset);

        Vector2 finalDirection = (toPlayer + perpendicular * wobble * wobbleStrength).normalized;
